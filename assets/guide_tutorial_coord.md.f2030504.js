...
const __pageData = JSON.parse('{"title":"坐标转换模块","description":"","frontmatter":{},"headers":[],"relativePath":"guide/tutorial/coord.md","filePath":"guide/tutorial/coord.md"}');
const _sfc_main = { name: "guide/tutorial/coord.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "坐标转换模块",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("坐标转换模块 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#坐标转换模块",
    "aria-label": 'Permalink to "坐标转换模块"'
  }, "​")
], -1);
const _hoisted_2 = [
  _hoisted_1

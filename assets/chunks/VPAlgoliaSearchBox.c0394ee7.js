import { d as defineComponent, K as useRoute, N as useRouter, i as onMounted, o as openBlock, c as createElementBlock } from "./framework.4fa5a9ca.js";
import { u as useConfig } from "./config.c72e478d.js";
import "./utils.7be6accc.js";
...
s.event = function(e2) {
  return xe && (e2 = xe(e2)), e2.persist = Ne, e2.isPropagationStopped = Re, e2.isDefaultPrevented = Te, e2.nativeEvent = e2;
};
...
var ct = function() {
}, it = [{ segment: "autocomplete-core", version: "1.8.2" }];
function lt(e2, t2) {
  var n2 = t2;
...
function Nt(e2, t2) {
  ...
  return At(At({ debug: false, openOnFocus: false, placeholder: "", autoFocus: false, defaultActiveItemId: null, stallThreshold: 300, environment: r2, shouldPanelOpen: function(e3) {
    return rt(e3.state) > 0;
  }, reshape: function(e3) {
    return e3.sources;
  } }, e2), {}, { id: null !== (n2 = e2.id) && void 0 !== n2 ? n2 : "autocomplete-".concat(nt++), plugins: o2, initialState: At({ activeItemId: null, query: "", completion: null, collections: [], isOpen: false, status: "idle", context: {} }, e2.initialState), onStateChange: function(t3) {
    var n3;
    ...
    return Promise.all([].concat(kt(o2.map(function(e3) {
      ...
      return function(e4, t3) {
        ...
        return Promise.resolve(e4(t3)).then(function(e5) {
          return Promise.all(e5.filter(function(e6) {
            ...
            if (ot("string" == typeof e6.sourceId), n4.includes(e6.sourceId))
      ...
      return e3.map(function(e4) {
        return At(At({}, e4), {}, { onSelect: function(n4) {
  ...
  }, navigator: At({ navigate: function(e3) {
    var t3 = e3.itemUrl;
...
function Wt(e2, t2, n2) {
  if (o2 = e2, Boolean(null == o2 ? void 0 : o2.execute)) {
    var r2 = "algolia" === e2.requesterId ? Object.assign.apply(Object, [{}].concat(Ft(Object.keys(n2.context).map(function(e3) {
      var t3;
      return null === (t3 = n2.context[e3]) || void 0 === t3 ? void 0 : t3.__algoliaSearchParameters;
    })))) : {};
    return Ht(Ht({}, e2), {}, { requests: e2.queries.map(function(n3) {
      return { query: "algolia" === e2.requesterId ? Ht(Ht({}, n3), {}, { params: Ht(Ht({}, r2), n3.params) }) : n3, sourceId: t2, transformResponse: e2.transformResponse };
    }) });
  }
  var o2;
...
function Kt(e2) {
  var t2 = e2.reduce(function(e3, t3) {
    ...
    var n2 = t3.searchClient, r2 = t3.execute, o2 = t3.requesterId, c2 = t3.requests, i2 = e3.find(function(e4) {
      return Vt(t3) && Vt(e4) && e4.searchClient === n2 && Boolean(o2) && e4.requesterId === o2;
    });
    if (i2) {
      var a2;
      (a2 = i2.items).push.apply(a2, Ft(c2));
    } else {
...
function zt(e2, t2, n2) {
  return t2.map(function(t3) {
    ...
    }), o2 = r2.map(function(e3) {
      return e3.items;
    }), c2 = r2[0].transformResponse, i2 = c2 ? c2(function(e3) {
    ...
    return t3.onResolve({ source: t3, results: o2, items: i2, state: n2.getState() }), ot(i2.every(Boolean), 'The `getItems` function from source "'.concat(t3.sourceId, '" must return an array of items but returned ').concat(JSON.stringify(void 0), ".\n\nDid you forget to return items?\n\nSee: https://www.algolia.com/doc/ui-libraries/autocomplete/core-concepts/sources/#param-getitems")), { source: t3, items: i2 };
  });
}
var Jt = ["event", "nextState", "props", "query", "refresh", "store"];
function $t(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
var Gt, Xt, en, tn = null, nn = (Gt = -1, Xt = -1, en = void 0, function(e2) {
  var t2 = ++Gt;
  return Promise.resolve(e2).then(function(e3) {
    return en && t2 < Xt ? en : (Xt = t2, en = e3, e3);
  });
});
function rn(e2) {
  var t2 = e2.event, n2 = e2.nextState, r2 = void 0 === n2 ? {} : n2, o2 = e2.props, c2 = e2.query, i2 = e2.refresh, a2 = e2.store, u2 = Yt(e2, Jt);
  ...
  var y2 = st(nn(o2.getSources(Qt({ query: c2, refresh: i2, state: a2.getState() }, u2)).then(function(e3) {
    return Promise.all(e3.map(function(e4) {
      return Promise.resolve(e4.getItems(Qt({ query: c2, refresh: i2, state: a2.getState() }, u2))).then(function(t3) {
        return Wt(t3, e4.sourceId, a2.getState());
      });
    })).then(Kt).then(function(t3) {
      return zt(t3, e3, a2);
    }).then(function(e4) {
      return function(e5) {
        var t3 = e5.collections, n3 = e5.props, r3 = e5.state, o3 = t3.reduce(function(e6, t4) {
          return Tt(Tt({}, e6), {}, Lt({}, t4.source.sourceId, Tt(Tt({}, t4.source), {}, { getItems: function() {
            return tt(t4.items);
          } })));
        }, {}), c3 = n3.plugins.reduce(function(e6, t4) {
          return t4.reshape ? t4.reshape(e6) : e6;
        }, { sourcesBySourceId: o3, state: r3 }).sourcesBySourceId;
        return tt(n3.reshape({ sourcesBySourceId: c3, sources: Object.values(c3), state: r3 })).filter(Boolean).map(function(e6) {
    ...
    if (null !== a2.getState().activeItemId && p3) {
      ...
      y3.onActive(Qt({ event: t2, item: d3, itemInputValue: h3, itemUrl: v3, refresh: i2, source: y3, state: a2.getState() }, u2));
    }
  }).finally(function() {
...
var on = ["event", "props", "refresh", "store"];
function cn(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
var sn = ["props", "refresh", "store"], fn = ["inputElement", "formElement", "panelElement"], pn = ["inputElement"], mn = ["inputElement", "maxLength"], dn = ["sourceIndex"], hn = ["sourceIndex"], vn = ["item", "source", "sourceIndex"];
function yn(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
function On(e2) {
  var t2 = e2.props, n2 = e2.refresh, r2 = e2.store, o2 = gn(e2, sn), c2 = function(e3, t3) {
    return void 0 !== t3 ? "".concat(e3, "-").concat(t3) : e3;
  };
  return { getEnvironmentProps: function(e3) {
    var n3 = e3.inputElement, o3 = e3.formElement, c3 = e3.panelElement;
    function i2(e4) {
      !r2.getState().isOpen && r2.pendingRequests.isEmpty() || e4.target === n3 || false === [o3, c3].some(function(t3) {
        return n4 = t3, r3 = e4.target, n4 === r3 || n4.contains(r3);
        var n4, r3;
      }) && (r2.dispatch("blur", null), t2.debug || r2.pendingRequests.cancelAll());
    }
    return _n({ onTouchStart: i2, onMouseDown: i2, onTouchMove: function(e4) {
      false !== r2.getState().isOpen && n3 === t2.environment.document.activeElement && e4.target !== n3 && n3.blur();
    } }, gn(e3, fn));
  }, getRootProps: function(e3) {
    return _n({ role: "combobox", "aria-expanded": r2.getState().isOpen, "aria-haspopup": "listbox", "aria-owns": r2.getState().isOpen ? "".concat(t2.id, "-list") : void 0, "aria-labelledby": "".concat(t2.id, "-label") }, e3);
  }, getFormProps: function(e3) {
    e3.inputElement;
    return _n({ action: "", noValidate: true, role: "search", onSubmit: function(c3) {
      var i2;
      c3.preventDefault(), t2.onSubmit(_n({ event: c3, refresh: n2, state: r2.getState() }, o2)), r2.dispatch("submit", null), null === (i2 = e3.inputElement) || void 0 === i2 || i2.blur();
    }, onReset: function(c3) {
      var i2;
      c3.preventDefault(), t2.onReset(_n({ event: c3, refresh: n2, state: r2.getState() }, o2)), r2.dispatch("reset", null), null === (i2 = e3.inputElement) || void 0 === i2 || i2.focus();
    } }, gn(e3, pn));
  }, getLabelProps: function(e3) {
    var n3 = e3 || {}, r3 = n3.sourceIndex, o3 = gn(n3, dn);
    return _n({ htmlFor: "".concat(c2(t2.id, r3), "-input"), id: "".concat(c2(t2.id, r3), "-label") }, o3);
  }, getInputProps: function(e3) {
    var c3;
    function i2(e4) {
      (t2.openOnFocus || Boolean(r2.getState().query)) && rn(_n({ event: e4, props: t2, query: r2.getState().completion || r2.getState().query, refresh: n2, store: r2 }, o2)), r2.dispatch("focus", null);
    }
    var a2 = e3 || {}, u2 = (a2.inputElement, a2.maxLength), l2 = void 0 === u2 ? 512 : u2, s2 = gn(a2, mn), f2 = yt(r2.getState()), p2 = function(e4) {
      return Boolean(e4 && e4.match(_t));
    }((null === (c3 = t2.environment.navigator) || void 0 === c3 ? void 0 : c3.userAgent) || ""), m2 = null != f2 && f2.itemUrl && !p2 ? "go" : "search";
    return _n({ "aria-autocomplete": "both", "aria-activedescendant": r2.getState().isOpen && null !== r2.getState().activeItemId ? "".concat(t2.id, "-item-").concat(r2.getState().activeItemId) : void 0, "aria-controls": r2.getState().isOpen ? "".concat(t2.id, "-list") : void 0, "aria-labelledby": "".concat(t2.id, "-label"), value: r2.getState().completion || r2.getState().query, id: "".concat(t2.id, "-input"), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", enterKeyHint: m2, spellCheck: "false", autoFocus: t2.autoFocus, placeholder: t2.placeholder, maxLength: l2, type: "search", onChange: function(e4) {
      rn(_n({ event: e4, props: t2, query: e4.currentTarget.value.slice(0, l2), refresh: n2, store: r2 }, o2));
    }, onKeyDown: function(e4) {
      !function(e5) {
        var t3 = e5.event, n3 = e5.props, r3 = e5.refresh, o3 = e5.store, c4 = ln(e5, on);
        if ("ArrowUp" === t3.key || "ArrowDown" === t3.key) {
          var i3 = function() {
            ...
            if (null !== o3.getState().activeItemId && e6) {
              ...
              u4.onActive(an({ event: t3, item: n4, itemInputValue: i4, itemUrl: a4, refresh: r3, source: u4, state: o3.getState() }, c4));
            }
          };
          t3.preventDefault(), false === o3.getState().isOpen && (n3.openOnFocus || Boolean(o3.getState().query)) ? rn(an({ event: t3, props: n3, query: o3.getState().query, refresh: r3, store: o3 }, c4)).then(function() {
          ...
          if (t3.metaKey || t3.ctrlKey)
            void 0 !== f3 && (p3.onSelect(an({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, c4)), n3.navigator.navigateNewTab({ itemUrl: f3, item: l3, state: o3.getState() }));
          else if (t3.shiftKey)
            void 0 !== f3 && (p3.onSelect(an({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, c4)), n3.navigator.navigateNewWindow({ itemUrl: f3, item: l3, state: o3.getState() }));
          else if (t3.altKey)
            ;
          else {
            if (void 0 !== f3)
              return p3.onSelect(an({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, c4)), void n3.navigator.navigate({ itemUrl: f3, item: l3, state: o3.getState() });
            rn(an({ event: t3, nextState: { isOpen: false }, props: n3, query: s3, refresh: r3, store: o3 }, c4)).then(function() {
              p3.onSelect(an({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, c4));
            });
          }
        }
      }(_n({ event: e4, props: t2, refresh: n2, store: r2 }, o2));
    ...
    return _n({ onMouseDown: function(e4) {
      e4.preventDefault();
    }, onMouseLeave: function() {
      r2.dispatch("mouseleave", null);
    } }, e3);
  }, getListProps: function(e3) {
    var n3 = e3 || {}, r3 = n3.sourceIndex, o3 = gn(n3, hn);
    return _n({ role: "listbox", "aria-labelledby": "".concat(c2(t2.id, r3), "-label"), id: "".concat(c2(t2.id, r3), "-list") }, o3);
  }, getItemProps: function(e3) {
    var i2 = e3.item, a2 = e3.source, u2 = e3.sourceIndex, l2 = gn(e3, vn);
    return _n({ id: "".concat(c2(t2.id, u2), "-item-").concat(i2.__autocomplete_id), role: "option", "aria-selected": r2.getState().activeItemId === i2.__autocomplete_id, onMouseMove: function(e4) {
      if (i2.__autocomplete_id !== r2.getState().activeItemId) {
        r2.dispatch("mousemove", i2.__autocomplete_id);
        var t3 = yt(r2.getState());
        if (null !== r2.getState().activeItemId && t3) {
          var c3 = t3.item, a3 = t3.itemInputValue, u3 = t3.itemUrl, l3 = t3.source;
          l3.onActive(_n({ event: e4, item: c3, itemInputValue: a3, itemUrl: u3, refresh: n2, source: l3, state: r2.getState() }, o2));
        }
      }
    }, onMouseDown: function(e4) {
      e4.preventDefault();
    }, onClick: function(e4) {
      var c3 = a2.getItemInputValue({ item: i2, state: r2.getState() }), u3 = a2.getItemUrl({ item: i2, state: r2.getState() });
      (u3 ? Promise.resolve() : rn(_n({ event: e4, nextState: { isOpen: false }, props: t2, query: c3, refresh: n2, store: r2 }, o2))).then(function() {
        a2.onSelect(_n({ event: e4, item: i2, itemInputValue: c3, itemUrl: u3, refresh: n2, source: a2, state: r2.getState() }, o2));
      });
    } }, l2);
  } };
}
...
function jn(e2) {
  var t2, n2, r2, o2, c2 = e2.plugins, i2 = e2.options, a2 = null === (t2 = ((null === (n2 = i2.__autocomplete_metadata) || void 0 === n2 ? void 0 : n2.userAgents) || [])[0]) || void 0 === t2 ? void 0 : t2.segment, u2 = a2 ? wn({}, a2, Object.keys((null === (r2 = i2.__autocomplete_metadata) || void 0 === r2 ? void 0 : r2.options) || {})) : {};
  return { plugins: c2.map(function(e3) {
    return { name: e3.name, options: Object.keys(e3.__autocomplete_pluginOptions || []) };
  }), options: En({ "autocomplete-core": Object.keys(i2) }, u2), ua: it.concat((null === (o2 = i2.__autocomplete_metadata) || void 0 === o2 ? void 0 : o2.userAgents) || []) };
}
function Pn(e2) {
  var t2, n2 = e2.state;
...
var Cn = function(e2, t2) {
  switch (t2.type) {
    ...
    case "mousemove":
      return kn(kn({}, e2), {}, { activeItemId: t2.payload });
    case "setQuery":
      return kn(kn({}, e2), {}, { query: t2.payload, completion: null });
    case "setCollections":
      return kn(kn({}, e2), {}, { collections: t2.payload });
    case "setIsOpen":
      return kn(kn({}, e2), {}, { isOpen: t2.payload });
    case "setStatus":
      return kn(kn({}, e2), {}, { status: t2.payload });
    case "setContext":
      return kn(kn({}, e2), {}, { context: kn(kn({}, e2.context), t2.payload) });
    case "ArrowDown":
      var n2 = kn(kn({}, e2), {}, { activeItemId: t2.payload.hasOwnProperty("nextActiveItemId") ? t2.payload.nextActiveItemId : pt(1, e2.activeItemId, rt(e2), t2.props.defaultActiveItemId) });
      return kn(kn({}, n2), {}, { completion: Pn({ state: n2 }) });
    case "ArrowUp":
      var r2 = kn(kn({}, e2), {}, { activeItemId: pt(-1, e2.activeItemId, rt(e2), t2.props.defaultActiveItemId) });
      return kn(kn({}, r2), {}, { completion: Pn({ state: r2 }) });
    case "Escape":
      return e2.isOpen ? kn(kn({}, e2), {}, { activeItemId: null, isOpen: false, completion: null }) : kn(kn({}, e2), {}, { activeItemId: null, query: "", status: "idle", collections: [] });
    case "submit":
      return kn(kn({}, e2), {}, { activeItemId: null, isOpen: false, status: "idle" });
    case "reset":
      return kn(kn({}, e2), {}, { activeItemId: true === t2.props.openOnFocus ? t2.props.defaultActiveItemId : null, status: "idle", query: "" });
    case "focus":
      return kn(kn({}, e2), {}, { activeItemId: t2.props.defaultActiveItemId, isOpen: (t2.props.openOnFocus || Boolean(e2.query)) && t2.props.shouldPanelOpen({ state: e2 }) });
    case "blur":
      return t2.props.debug ? e2 : kn(kn({}, e2), {}, { isOpen: false, activeItemId: null });
    case "mouseleave":
      return kn(kn({}, e2), {}, { activeItemId: t2.props.defaultActiveItemId });
    default:
...
function Rn(e2) {
  var t2 = [], n2 = Nt(e2, t2), r2 = wt(Cn, n2, function(e3) {
    var t3 = e3.prevState, r3 = e3.state;
    n2.onStateChange(xn({ prevState: t3, state: r3, refresh: i2, navigator: n2.navigator }, o2));
  }), o2 = function(e3) {
    var t3 = e3.store;
  ...
  }({ store: r2 }), c2 = On(xn({ props: n2, refresh: i2, store: r2, navigator: n2.navigator }, o2));
  function i2() {
    return rn(xn({ event: new Event("input"), nextState: { isOpen: r2.getState().isOpen }, props: n2, navigator: n2.navigator, query: r2.getState().query, refresh: i2, store: r2 }, o2));
  }
  return n2.plugins.forEach(function(e3) {
    var r3;
    return null === (r3 = e3.subscribe) || void 0 === r3 ? void 0 : r3.call(e3, xn(xn({}, o2), {}, { navigator: n2.navigator, refresh: i2, onSelect: function(e4) {
      t2.push({ onSelect: e4 });
  ...
  }({ metadata: jn({ plugins: n2.plugins, options: e2 }), environment: n2.environment }), xn(xn({ refresh: i2, navigator: n2.navigator }, c2), o2);
}
function Tn(e2) {
...
function qn(e2) {
  ...
  return Be.createElement(Be.Fragment, null, Be.createElement("div", { className: "DocSearch-Logo" }, Be.createElement(Tn, { translations: { searchByText: _2 } })), Be.createElement("ul", { className: "DocSearch-Commands" }, Be.createElement("li", null, Be.createElement("kbd", { className: "DocSearch-Commands-Key" }, Be.createElement(Ln, { ariaLabel: i2 }, Be.createElement("path", { d: "M12 3.53088v3c0 1-1 2-2 2H4M7 11.53088l-3-3 3-3" }))), Be.createElement("span", { className: "DocSearch-Label" }, o2)), Be.createElement("li", null, Be.createElement("kbd", { className: "DocSearch-Commands-Key" }, Be.createElement(Ln, { ariaLabel: p2 }, Be.createElement("path", { d: "M7.5 3.5v8M10.5 8.5l-3 3-3-3" }))), Be.createElement("kbd", { className: "DocSearch-Commands-Key" }, Be.createElement(Ln, { ariaLabel: s2 }, Be.createElement("path", { d: "M7.5 11.5v-8M10.5 6.5l-3-3-3 3" }))), Be.createElement("span", { className: "DocSearch-Label" }, u2)), Be.createElement("li", null, Be.createElement("kbd", { className: "DocSearch-Commands-Key" }, Be.createElement(Ln, { ariaLabel: v2 }, Be.createElement("path", { d: "M13.6167 8.936c-.1065.3583-.6883.962-1.4875.962-.7993 0-1.653-.9165-1.653-2.1258v-.5678c0-1.2548.7896-2.1016 1.653-2.1016.8634 0 1.3601.4778 1.4875 1.0724M9 6c-.1352-.4735-.7506-.9219-1.46-.8972-.7092.0246-1.344.57-1.344 1.2166s.4198.8812 1.3445.9805C8.465 7.3992 8.968 7.9337 9 8.5c.032.5663-.454 1.398-1.4595 1.398C6.6593 9.898 6 9 5.963 8.4851m-1.4748.5368c-.2635.5941-.8099.876-1.5443.876s-1.7073-.6248-1.7073-2.204v-.4603c0-1.0416.721-2.131 1.7073-2.131.9864 0 1.6425 1.031 1.5443 2.2492h-2.956" }))), Be.createElement("span", { className: "DocSearch-Label" }, d2))));
}
function Mn(e2) {
...
function Wn(e2) {
  switch (e2.type) {
    ...
    case "content":
      return Be.createElement(zn, null);
    default:
      return Be.createElement(Kn, null);
  }
}
function Kn() {
...
function Zn(e2) {
  ...
  return Be.createElement("div", { className: "DocSearch-ErrorScreen" }, Be.createElement("div", { className: "DocSearch-Screen-Icon" }, Be.createElement($n, null)), Be.createElement("p", { className: "DocSearch-Title" }, o2), Be.createElement("p", { className: "DocSearch-Help" }, i2));
}
var Yn = ["translations"];
function Gn(e2) {
  return function(e3) {
...
function tr(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = er(e2, Yn), o2 = n2.noResultsText, c2 = void 0 === o2 ? "No results for" : o2, i2 = n2.suggestedQueryText, a2 = void 0 === i2 ? "Try searching for" : i2, u2 = n2.reportMissingResultsText, l2 = void 0 === u2 ? "Believe this query should return results?" : u2, s2 = n2.reportMissingResultsLinkText, f2 = void 0 === s2 ? "Let us know." : s2, p2 = r2.state.context.searchSuggestions;
  return Be.createElement("div", { className: "DocSearch-NoResults" }, Be.createElement("div", { className: "DocSearch-Screen-Icon" }, Be.createElement(Qn, null)), Be.createElement("p", { className: "DocSearch-Title" }, c2, ' "', Be.createElement("strong", null, r2.state.query), '"'), p2 && p2.length > 0 && Be.createElement("div", { className: "DocSearch-NoResults-Prefill-List" }, Be.createElement("p", { className: "DocSearch-Help" }, a2, ":"), Be.createElement("ul", null, p2.slice(0, 3).reduce(function(e3, t3) {
    return [].concat(Gn(e3), [Be.createElement("li", { key: t3 }, Be.createElement("button", { className: "DocSearch-Prefill", key: t3, type: "button", onClick: function() {
...
function ur(e2) {
  ...
  return g(void 0 === r2 ? "span" : r2, or(or({}, ir(e2, nr)), {}, { dangerouslySetInnerHTML: { __html: ar(t2, "_snippetResult.".concat(n2, ".value")) || ar(t2, n2) } }));
}
function lr(e2, t2) {
  return function(e3) {
    if (Array.isArray(e3))
...
function pr(e2) {
  return e2.collection && 0 !== e2.collection.items.length ? Be.createElement("section", { className: "DocSearch-Hits" }, Be.createElement("div", { className: "DocSearch-Hit-source" }, e2.title), Be.createElement("ul", e2.getListProps(), e2.collection.items.map(function(t2, n2) {
    return Be.createElement(mr, fr({ key: [e2.title, t2.objectID].join(":"), item: t2, index: n2 }, e2));
  }))) : null;
}
function mr(e2) {
  var t2 = e2.item, n2 = e2.index, r2 = e2.renderIcon, o2 = e2.renderAction, c2 = e2.getItemProps, i2 = e2.onItemClick, a2 = e2.collection, u2 = e2.hitComponent, l2 = lr(Be.useState(false), 2), s2 = l2[0], f2 = l2[1], p2 = lr(Be.useState(false), 2), m2 = p2[0], d2 = p2[1], h2 = Be.useRef(null), v2 = u2;
  return Be.createElement("li", fr({ className: ["DocSearch-Hit", t2.__docsearch_parent && "DocSearch-Hit--Child", s2 && "DocSearch-Hit--deleting", m2 && "DocSearch-Hit--favoriting"].filter(Boolean).join(" "), onTransitionEnd: function() {
    h2.current && h2.current();
  } }, c2({ item: t2, source: a2.source, onClick: function(e3) {
    i2(t2, e3);
  } })), Be.createElement(v2, { hit: t2 }, Be.createElement("div", { className: "DocSearch-Hit-Container" }, r2({ item: t2, index: n2 }), t2.hierarchy[t2.type] && "lvl1" === t2.type && Be.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Be.createElement(ur, { className: "DocSearch-Hit-title", hit: t2, attribute: "hierarchy.lvl1" }), t2.content && Be.createElement(ur, { className: "DocSearch-Hit-path", hit: t2, attribute: "content" })), t2.hierarchy[t2.type] && ("lvl2" === t2.type || "lvl3" === t2.type || "lvl4" === t2.type || "lvl5" === t2.type || "lvl6" === t2.type) && Be.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Be.createElement(ur, { className: "DocSearch-Hit-title", hit: t2, attribute: "hierarchy.".concat(t2.type) }), Be.createElement(ur, { className: "DocSearch-Hit-path", hit: t2, attribute: "hierarchy.lvl1" })), "content" === t2.type && Be.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Be.createElement(ur, { className: "DocSearch-Hit-title", hit: t2, attribute: "content" }), Be.createElement(ur, { className: "DocSearch-Hit-path", hit: t2, attribute: "hierarchy.lvl1" })), o2({ item: t2, runDeleteTransition: function(e3) {
...
var _r = /(<mark>|<\/mark>)/g, br = RegExp(_r.source);
function gr(e2) {
  ...
  return a2 && br.test(a2) ? a2.replace(_r, "") : a2;
}
function Or() {
...
function Sr(e2) {
  return Be.createElement("div", { className: "DocSearch-Dropdown-Container" }, e2.state.collections.map(function(t2) {
    if (0 === t2.items.length)
      return null;
    var n2 = gr(t2.items[0]);
    return Be.createElement(pr, Or({}, e2, { key: t2.source.sourceId, title: n2, collection: t2, renderIcon: function(e3) {
      var n3, r2 = e3.item, o2 = e3.index;
      return Be.createElement(Be.Fragment, null, r2.__docsearch_parent && Be.createElement("svg", { className: "DocSearch-Hit-Tree", viewBox: "0 0 24 54" }, Be.createElement("g", { stroke: "currentColor", fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" }, r2.__docsearch_parent !== (null === (n3 = t2.items[o2 + 1]) || void 0 === n3 ? void 0 : n3.__docsearch_parent) ? Be.createElement("path", { d: "M8 6v21M20 27H8.3" }) : Be.createElement("path", { d: "M8 6v42M20 27H8.3" }))), Be.createElement("div", { className: "DocSearch-Hit-icon" }, Be.createElement(Wn, { type: r2.type })));
    }, renderAction: function() {
      return Be.createElement("div", { className: "DocSearch-Hit-action" }, Be.createElement(Bn, null));
    } }));
...
function Pr(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = jr(e2, Er), o2 = n2.recentSearchesTitle, c2 = void 0 === o2 ? "Recent" : o2, i2 = n2.noRecentSearchesText, a2 = void 0 === i2 ? "No recent searches" : i2, u2 = n2.saveRecentSearchButtonTitle, l2 = void 0 === u2 ? "Save this search" : u2, s2 = n2.removeRecentSearchButtonTitle, f2 = void 0 === s2 ? "Remove this search from history" : s2, p2 = n2.favoriteSearchesTitle, m2 = void 0 === p2 ? "Favorite" : p2, d2 = n2.removeFavoriteSearchButtonTitle, h2 = void 0 === d2 ? "Remove this search from favorites" : d2;
  return "idle" === r2.state.status && false === r2.hasCollections ? r2.disableUserPersonalization ? null : Be.createElement("div", { className: "DocSearch-StartScreen" }, Be.createElement("p", { className: "DocSearch-Help" }, a2)) : false === r2.hasCollections ? null : Be.createElement("div", { className: "DocSearch-Dropdown-Container" }, Be.createElement(pr, wr({}, r2, { title: c2, collection: r2.state.collections[0], renderIcon: function() {
    return Be.createElement("div", { className: "DocSearch-Hit-icon" }, Be.createElement(Un, null));
    ...
    } }, Be.createElement(Jn, null))), Be.createElement("div", { className: "DocSearch-Hit-action" }, Be.createElement("button", { className: "DocSearch-Hit-action-button", title: f2, type: "submit", onClick: function(e4) {
      e4.preventDefault(), e4.stopPropagation(), o3(function() {
        r2.recentSearches.remove(t3), r2.refresh();
      });
    } }, Be.createElement(Fn, null))));
  } })), Be.createElement(pr, wr({}, r2, { title: m2, collection: r2.state.collections[1], renderIcon: function() {
    return Be.createElement("div", { className: "DocSearch-Hit-icon" }, Be.createElement(Jn, null));
  }, renderAction: function(e3) {
...
var Cr = Be.memo(function(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = Dr(e2, Ir);
  if ("error" === r2.state.status)
    return Be.createElement(Zn, { translations: null == n2 ? void 0 : n2.errorScreen });
  var o2 = r2.state.collections.some(function(e3) {
    return e3.items.length > 0;
  });
  return r2.state.query ? false === o2 ? Be.createElement(tr, kr({}, r2, { translations: null == n2 ? void 0 : n2.noResultsScreen })) : Be.createElement(Sr, r2) : Be.createElement(Pr, kr({}, r2, { hasCollections: o2, translations: null == n2 ? void 0 : n2.startScreen }));
}, function(e2, t2) {
  return "loading" === t2.state.status || "stalled" === t2.state.status;
}), Ar = ["translations"];
function xr() {
  return xr = Object.assign || function(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n2 = arguments[t2];
      for (var r2 in n2)
        Object.prototype.hasOwnProperty.call(n2, r2) && (e2[r2] = n2[r2]);
...
function Rr(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = Nr(e2, Ar), o2 = n2.resetButtonTitle, c2 = void 0 === o2 ? "Clear the query" : o2, i2 = n2.resetButtonAriaLabel, a2 = void 0 === i2 ? "Clear the query" : i2, u2 = n2.cancelButtonText, l2 = void 0 === u2 ? "Cancel" : u2, s2 = n2.cancelButtonAriaLabel, f2 = void 0 === s2 ? "Cancel" : s2, p2 = r2.getFormProps({ inputElement: r2.inputRef.current }).onReset;
  return Be.useEffect(function() {
    ...
    e3.preventDefault();
  }, onReset: p2 }, Be.createElement("label", xr({ className: "DocSearch-MagnifierLabel" }, r2.getLabelProps()), Be.createElement(We, null)), Be.createElement("div", { className: "DocSearch-LoadingIndicator" }, Be.createElement(Hn, null)), Be.createElement("input", xr({ className: "DocSearch-Input", ref: r2.inputRef }, r2.getInputProps({ inputElement: r2.inputRef.current, autoFocus: r2.autoFocus, maxLength: 64 }))), Be.createElement("button", { type: "reset", title: c2, className: "DocSearch-Reset", "aria-label": a2, hidden: !r2.state.query }, Be.createElement(Fn, null))), Be.createElement("button", { className: "DocSearch-Cancel", type: "reset", "aria-label": f2, onClick: r2.onClose }, l2));
}
var Tr = ["_highlightResult", "_snippetResult"];
function Lr(e2, t2) {
  if (null == e2)
    return {};
  var n2, r2, o2 = function(e3, t3) {
...
function Mr(e2) {
  var t2 = e2.key, n2 = e2.limit, r2 = void 0 === n2 ? 5 : n2, o2 = qr(t2), c2 = o2.getItem().slice(0, r2);
  return { add: function(e3) {
    var t3 = e3, n3 = (t3._highlightResult, t3._snippetResult, Lr(t3, Tr)), i2 = c2.findIndex(function(e4) {
...
function Fr(e2) {
  ...
  return void 0 === n2 ? { get: function(e3, t3) {
    ...
    return n2.get(e3, r2, o2).catch(function() {
      return Fr({ caches: t2 }).get(e3, r2, o2);
    });
  }, set: function(e3, r2) {
    return n2.set(e3, r2).catch(function() {
      return Fr({ caches: t2 }).set(e3, r2);
    });
  }, delete: function(e3) {
    return n2.delete(e3).catch(function() {
      return Fr({ caches: t2 }).delete(e3);
    });
  }, clear: function() {
    return n2.clear().catch(function() {
      return Fr({ caches: t2 }).clear();
    });
  } };
}
function Br() {
...
var zr = { WithinQueryParameters: 0, WithinHeaders: 1 };
function Jr(e2, t2) {
...
var $r = { Read: 1, Write: 2, Any: 3 }, Qr = 1, Zr = 2, Yr = 3;
function Gr(e2) {
  var n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Qr;
  return t(t({}, e2), {}, { status: n2, lastUpdate: Date.now() });
}
function Xr(e2) {
  return "string" == typeof e2 ? { protocol: "https", url: e2, accept: $r.Any } : { protocol: e2.protocol || "https", url: e2.url, accept: e2.accept || $r.Any };
}
var eo = "GET", to = "POST";
function no(e2, t2) {
  return Promise.all(t2.map(function(t3) {
    return e2.get(t3, function() {
      return Promise.resolve(Gr(t3));
    });
  })).then(function(e3) {
    var n2 = e3.filter(function(e4) {
      return function(e5) {
        return e5.status === Qr || Date.now() - e5.lastUpdate > 12e4;
      }(e4);
    }), r2 = e3.filter(function(e4) {
      return function(e5) {
        return e5.status === Yr && Date.now() - e5.lastUpdate <= 12e4;
      }(e4);
    }), o2 = [].concat(a(n2), a(r2));
...
function ro(e2, n2, r2, o2) {
  var c2 = [], i2 = function(e3, n3) {
    if (e3.method === eo || void 0 === e3.data && void 0 === n3.data)
      return;
  ...
  }(e2, o2), l2 = r2.method, s2 = r2.method !== eo ? {} : t(t({}, r2.data), o2.data), f2 = t(t(t({ "x-algolia-agent": e2.userAgent.value }, e2.queryParameters), s2), o2.queryParameters), p2 = 0, m2 = function t2(n3, a2) {
    var s3 = n3.pop();
    if (void 0 === s3)
      throw { name: "RetryError", message: "Unreachable hosts - your application id may be incorrect. If the error persists, contact support@algolia.com.", transporterStackTrace: ao(c2) };
    var m3 = { data: i2, headers: u2, method: l2, url: co(s3, r2.path, f2), connectTimeout: a2(p2, e2.timeouts.connect), responseTimeout: a2(p2, o2.timeout) }, d2 = function(e3) {
      ...
      var o3 = d2(r3);
      return r3.isTimedOut && p2++, Promise.all([e2.logger.info("Retryable failure", uo(o3)), e2.hostsCache.set(s3, Gr(s3, r3.isTimedOut ? Yr : Zr))]).then(function() {
        return t2(n3, a2);
      });
    }, onFail: function(e3) {
  ...
  return no(e2.hostsCache, n2).then(function(e3) {
...
function co(e2, t2, n2) {
  var r2 = io(n2), o2 = "".concat(e2.protocol, "://").concat(e2.url, "/").concat("/" === t2.charAt(0) ? t2.substr(1) : t2);
  return r2.length && (o2 += "?".concat(r2)), o2;
}
function io(e2) {
  return Object.keys(e2).map(function(t2) {
    return Kr("%s=%s", t2, (n2 = e2[t2], "[object Object]" === Object.prototype.toString.call(n2) || "[object Array]" === Object.prototype.toString.call(n2) ? JSON.stringify(e2[t2]) : e2[t2]));
    var n2;
  }).join("&");
}
function ao(e2) {
...
var lo = function(e2) {
  var n2 = e2.appId, r2 = function(e3, t2, n3) {
    ...
    return { headers: function() {
      return e3 === zr.WithinHeaders ? r3 : {};
    }, queryParameters: function() {
      return e3 === zr.WithinQueryParameters ? r3 : {};
    } };
  }(void 0 !== e2.authMode ? e2.authMode : zr.WithinHeaders, n2, e2.apiKey), o2 = function(e3) {
    var t2 = e3.hostsCache, n3 = e3.logger, r3 = e3.requester, o3 = e3.requestsCache, c3 = e3.responsesCache, a2 = e3.timeouts, u2 = e3.userAgent, l2 = e3.hosts, s2 = e3.queryParameters, f2 = { hostsCache: t2, logger: n3, requester: r3, requestsCache: o3, responsesCache: c3, timeouts: a2, userAgent: u2, headers: e3.headers, queryParameters: s2, hosts: l2.map(function(e4) {
      ...
      var n4 = Jr(t3, f2.timeouts.read), r4 = function() {
        return ro(f2, f2.hosts.filter(function(e5) {
          return 0 != (e5.accept & $r.Read);
        }), e4, n4);
      };
      ...
      return ro(f2, f2.hosts.filter(function(e5) {
        return 0 != (e5.accept & $r.Write);
      }), e4, Jr(t3, f2.timeouts.write));
    } };
    return f2;
  }(t(t({ hosts: [{ url: "".concat(n2, "-dsn.algolia.net"), accept: $r.Read }, { url: "".concat(n2, ".algolia.net"), accept: $r.Write }].concat(Vr([{ url: "".concat(n2, "-1.algolianet.com") }, { url: "".concat(n2, "-2.algolianet.com") }, { url: "".concat(n2, "-3.algolianet.com") }])) }, e2), {}, { headers: t(t(t({}, r2.headers()), { "content-type": "application/x-www-form-urlencoded" }), e2.headers), queryParameters: t(t({}, r2.queryParameters()), e2.queryParameters) })), c2 = { transporter: o2, appId: n2, addAlgoliaAgent: function(e3, t2) {
    o2.userAgent.add({ segment: e3, version: t2 });
  }, clearCache: function() {
    return Promise.all([o2.requestsCache.clear(), o2.responsesCache.clear()]).then(function() {
    });
  } };
  return Wr(c2, e2.methods);
}, so = function(e2) {
  return function(t2) {
    var n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r2 = { transporter: e2.transporter, appId: e2.appId, indexName: t2 };
    return Wr(r2, n2.methods);
  };
}, fo = function(e2) {
  return function(n2, r2) {
    var o2 = n2.map(function(e3) {
      return t(t({}, e3), {}, { params: io(e3.params || {}) });
    });
    return e2.transporter.read({ method: to, path: "1/indexes/*/queries", data: { requests: o2 }, cacheable: true }, r2);
  };
}, po = function(e2) {
  return function(n2, r2) {
    return Promise.all(n2.map(function(n3) {
      var o2 = n3.params, i2 = o2.facetName, a2 = o2.facetQuery, u2 = c(o2, Hr);
      return so(e2)(n3.indexName, { methods: { searchForFacetValues: vo } }).searchForFacetValues(i2, a2, t(t({}, r2), u2));
    }));
  };
}, mo = function(e2) {
  return function(t2, n2, r2) {
    return e2.transporter.read({ method: to, path: Kr("1/answers/%s/prediction", e2.indexName), data: { query: t2, queryLanguages: n2 }, cacheable: true }, r2);
  };
}, ho = function(e2) {
  return function(t2, n2) {
    return e2.transporter.read({ method: to, path: Kr("1/indexes/%s/query", e2.indexName), data: { query: t2 }, cacheable: true }, n2);
  };
}, vo = function(e2) {
  return function(t2, n2, r2) {
    return e2.transporter.read({ method: to, path: Kr("1/indexes/%s/facets/%s/query", e2.indexName, t2), data: { facetQuery: n2 }, cacheable: true }, r2);
  };
}, yo = 1, _o = 2, bo = 3;
function go(e2, n2, r2) {
  ...
  } }, logger: (o2 = bo, { debug: function(e3, t2) {
    return yo >= o2 && console.debug(e3, t2), Promise.resolve();
  }, info: function(e3, t2) {
    return _o >= o2 && console.info(e3, t2), Promise.resolve();
  }, error: function(e3, t2) {
    return console.error(e3, t2), Promise.resolve();
  } }), responsesCache: Br(), requestsCache: Br({ serializable: false }), hostsCache: Fr({ caches: [Ur({ key: "".concat("4.8.5", "-").concat(e2) }), Br()] }), userAgent: oo("4.8.5").add({ segment: "Browser", version: "lite" }), authMode: zr.WithinQueryParameters };
  return lo(t(t(t({}, c2), r2), {}, { methods: { search: fo, searchForFacetValues: po, multipleQueries: fo, multipleSearchForFacetValues: po, initIndex: function(e3) {
    return function(t2) {
      return so(e3)(t2, { methods: { search: ho, searchForFacetValues: vo, findAnswers: mo } });
    };
  } } }));
}
go.version = "4.8.5";
var Oo = ["footer", "searchBox"];
function So() {
...
function wo(e2) {
  for (var t2 = 1; t2 < arguments.length; t2++) {
    var n2 = null != arguments[t2] ? arguments[t2] : {};
    t2 % 2 ? Eo(Object(n2), true).forEach(function(t3) {
      jo(e2, t3, n2[t3]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n2)) : Eo(Object(n2)).forEach(function(t3) {
      Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n2, t3));
    });
  }
  return e2;
...
function No(e2) {
  var t2, n2, r2 = Be.useRef(null), o2 = Ao(Be.useState(false), 2), c2 = o2[0], i2 = o2[1], a2 = Ao(Be.useState((null == e2 ? void 0 : e2.initialQuery) || void 0), 2), u2 = a2[0], l2 = a2[1], s2 = Be.useCallback(function() {
    i2(true);
  ...
  return function(e3) {
    ...
    i2(true), l2(e3.key);
  }, [i2, l2]), searchButtonRef: r2 }), Be.createElement(Be.Fragment, null, Be.createElement(Ze, { ref: r2, translations: null == e2 || null === (t2 = e2.translations) || void 0 === t2 ? void 0 : t2.button, onClick: s2 }), c2 && Ie(Be.createElement(Do, Co({}, e2, { initialScrollY: window.scrollY, initialQuery: u2, translations: null == e2 || null === (n2 = e2.translations) || void 0 === n2 ? void 0 : n2.modal, onClose: f2 })), document.body));
}
function Ro(e2) {

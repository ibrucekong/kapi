import { _ as _sfc_main$3 } from "./chunks/index.a4250c47.js";
import { d as defineComponent, l as useData, o as openBlock, c as createElementBlock, e as createBaseVNode, F as Fragment, f as renderList, u as unref, t as toDisplayString, h as createVNode, m as withCtx, j as createTextVNode, i as onMounted, g as createCommentVNode, a as createStaticVNode, p as pushScopeId, k as popScopeId, _ as _export_sfc } from "./chunks/framework.c3f5e592.js";
import "./chunks/config.09408881.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-f2b41d5f"), n = n(), popScopeId(), n);
...
const _hoisted_7 = /* @__PURE__ */ createStaticVNode('<section id="highlights" class="vt-box-container" data-v-f2b41d5f><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高易用</h2><p data-v-f2b41d5f> 框架提供丰富、易上手和对新手友好的开发文档，简单易用 </p></div><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高兼容</h2><p data-v-f2b41d5f> 使用JavaScript编译，跨平台、跨终端，不挑前端框架 </p></div><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高性能</h2><p data-v-f2b41d5f> 高吞吐、低延迟、高精细和强大的粒子可视化效果 </p></div><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高安全</h2><p data-v-f2b41d5f> 数据完全云渲染，不被爬、不怕数据丢失，保障数据安全性 </p></div><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高逼真</h2><p data-v-f2b41d5f> 对真实世界1:1复刻，实现孪生世界与真实世界的联动 </p></div><div class="vt-box" data-v-f2b41d5f><h2 data-v-f2b41d5f>高并发</h2><p data-v-f2b41d5f> 实现多客户端的信息同步、画面同步、物联控制同步 </p></div></section>', 1);
...
const Home_vue_vue_type_style_index_0_scoped_f2b41d5f_lang = "";
const Home = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f2b41d5f"]]);
const __pageData = JSON.parse('{"title":"KAPI - 简单易用、超高性能、数据安全、功能强大的云渲染数字孪生框架","description":"","frontmatter":{"page":true,"title":"KAPI - 简单易用、超高性能、数据安全、功能强大的云渲染数字孪生框架"},"headers":[],"relativePath":"index.md"}');

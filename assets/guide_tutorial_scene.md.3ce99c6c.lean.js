...
const __pageData = JSON.parse('{"title":"场景模块","description":"","frontmatter":{},"headers":[],"relativePath":"guide/tutorial/scene.md","filePath":"guide/tutorial/scene.md"}');
const _sfc_main = { name: "guide/tutorial/scene.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "场景模块",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("场景模块 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#场景模块",
    "aria-label": 'Permalink to "场景模块"'
  }, "​")
], -1);
const _hoisted_2 = [
  _hoisted_1

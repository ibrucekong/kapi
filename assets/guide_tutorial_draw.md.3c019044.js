...
const __pageData = JSON.parse('{"title":"绘制模块","description":"","frontmatter":{},"headers":[],"relativePath":"guide/tutorial/draw.md","filePath":"guide/tutorial/draw.md"}');
const _sfc_main = { name: "guide/tutorial/draw.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "绘制模块",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("绘制模块 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#绘制模块",
    "aria-label": 'Permalink to "绘制模块"'
  }, "​")
], -1);
const _hoisted_2 = [
  _hoisted_1
